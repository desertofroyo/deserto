...
(function () {
  ...
  function Photo({ src, tint = "var(--peach-100)", label, height = "100%", radius = 0, pos = "center", style = {} }) {
    return (
      <div style={{
  ...
  function Arch({ children, radius = "50% 50% 0 0 / 38% 38% 0 0", style = {}, ...rest }) {
    return (
  ...
  window.Site = Object.assign(window.Site || {}, { Icon, Photo, Arch, Chip, useSeasonState, Marquee, IMG, ISO });
})();
