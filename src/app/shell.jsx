...
/* Deserto mobile app — shell parts: Photo, StatusBar, TabBar, Phone. */

export const ISO = "/assets/logos/deserto-isotype.png";
export const ISO_W = "/assets/logos/deserto-isotype-white.png";
const IMG = "/assets/images/";

export function Photo({ src, tint = "var(--peach-100)", label, height = "100%", radius = 0, iso = 0.16, pos = "center", style = {} }) {
  return (
...
export function TabBar({ tab, setTab, bagCount }) {
